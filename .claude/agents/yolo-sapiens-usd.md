...
- **PRIIPs KID constraint**: US-domiciled leveraged/inverse ETFs (SQQQ, SPXS, SPXU, TQQQ, UPRO, DUST, SCO) are blocked for EU retail. Use the `bearish-etfs-ucits` universe instead — full 3x coverage available: `3USS.L` / `3USL.L` (S&P 500 -3x/+3x), `QQQS.L` / `QQQ3.L` (Nasdaq -3x/+3x), plus European-index variants (`BX4.PA`, `3UKS.L`, `3EUS.MI`, `DXSN.DE`, `IBEXA.MC`).
