...
- **Yahoo holes are not our bug.** Yahoo intermittently serves a NaN close (European equities) or no row at all (crypto, 2026-08-05) for a given day. `build_new_rows` drops rows with no close. Once Yahoo stops serving a past day, that gap is unrecoverable.
