...
Commit message: "chore: weekday session {today}" (the orchestrator commits
data/ itself with this richer message before calling the helper; the helper
sees nothing staged and proceeds to the push).
